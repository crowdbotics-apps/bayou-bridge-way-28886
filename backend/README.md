...
## Project Structure
    ...
    ├── bayou_bridge_way_28886  # Django project configurations
...
1. Clone this repo and `cd bayou_bridge_way_28886`
...
2. Clone this repo and `cd bayou_bridge_way_28886`
